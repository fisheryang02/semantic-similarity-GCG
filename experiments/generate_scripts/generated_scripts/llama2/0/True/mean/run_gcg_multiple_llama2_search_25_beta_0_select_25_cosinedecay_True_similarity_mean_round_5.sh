...
nohup python -u ../main.py \
    ...
    --config.devices[0]="cuda" > $HOME/llm-attacks/experiments/llama2_with_cosdecay_and_mean_sentemb/round${round}/launch_scripts/multiple_llama2_search_25_beta_0_select_25_cosinedecay_True_round_${round}.log 2>&1 &
pid=$!
wait $pid
