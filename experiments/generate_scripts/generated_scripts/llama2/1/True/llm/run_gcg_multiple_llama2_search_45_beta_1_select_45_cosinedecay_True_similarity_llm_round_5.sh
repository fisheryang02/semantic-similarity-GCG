...
nohup python -u ../main.py \
    ...
    --config.result_prefix="$HOME/llm-attacks/experiments/${folder}/round${round}/results/multiple_llama2_search_45_beta_1_select_45_cosinedecay_True_round_${round}" \
    ...
    --config.devices[0]="cuda" > $HOME/llm-attacks/experiments/llama2_with_cosdecay_and_lasthiddenstate/round${round}/launch_scripts/multiple_llama2_search_45_beta_1_select_45_cosinedecay_True_round_${round}.log 2>&1 &
pid=$!
wait $pid
...
nohup python -u ../evaluate_llama2.py \
    --config="../configs/transfer_llama2.py"\
    --config.train_data="../../data/advbench/harmful_behaviors.csv" \
    --config.logfile="$HOME/llm-attacks/experiments/${folder}/round${round}/results/multiple_llama2_search_45_beta_1_select_45_cosinedecay_True_round_${round}.json"\
    --config.n_train_data=$n\
