...
nohup python -u ../main.py \
    ...
    --config.devices[0]="cuda" > $HOME/llm-attacks/experiments/vicuna_without_cosdecay_and_mean_sentemb/round${round}/launch_scripts/multiple_vicuna_search_35_beta_0_select_35_cosinedecay_False_round_${round}.log 2>&1 &
pid=$!
wait $pid
