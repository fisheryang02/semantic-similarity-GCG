...
nohup python -u ../main.py \
    ...
    --config.devices[0]="cuda" > $HOME/llm-attacks/experiments/vicuna_with_cosdecay_and_lasthiddenstate/round${round}/launch_scripts/multiple_vicuna_search_40_beta_0_select_40_cosinedecay_True_round_${round}.log 2>&1 &
pid=$!
wait $pid
