...
nohup python -u ../main.py \
    ...
    --config.result_prefix="$HOME/llm-attacks/experiments/${folder}/round${round}/results/multiple_vicuna_search_0_beta_0_select_0_cosinedecay_True_round_${round}" \
    ...
    --config.devices[0]="cuda" > $HOME/llm-attacks/experiments/vicuna_with_cosdecay_and_mean_sentemb/round${round}/launch_scripts/multiple_vicuna_search_0_beta_0_select_0_cosinedecay_True_round_${round}.log 2>&1 &
pid=$!
wait $pid
...
nohup python -u ../evaluate_vicuna.py \
    --config="../configs/transfer_vicuna.py"\
    --config.train_data="../../data/advbench/harmful_behaviors.csv" \
    --config.logfile="$HOME/llm-attacks/experiments/${folder}/round${round}/results/multiple_vicuna_search_0_beta_0_select_0_cosinedecay_True_round_${round}.json"\
    --config.n_train_data=$n\
